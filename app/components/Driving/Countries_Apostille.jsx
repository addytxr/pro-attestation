        ...
        >
          <div className="text-center space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
              Countries That Commonly Require Driving License Apostille
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              These Hague Convention member countries accept apostilled Driving License for various purposes
            </p>
          </div>
