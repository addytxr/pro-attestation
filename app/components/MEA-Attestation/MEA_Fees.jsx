      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          ...
          >
            ...
            <div>
              <h3 className="font-semibold text-lg text-gray-900 mb-2">Attestation Fees</h3>
              <p className="text-gray-700">Varies per document</p>
              <p className="text-gray-700 mt-1">Reach out for a quick quote</p>
            </div>
          </motion.div>
        </div>

        <p className="text-lg text-gray-700">
          No hidden charges. Transparent pricing. Fastest MEA attestation service guaranteed.
        </p>
      </div>
    </div>
  )
