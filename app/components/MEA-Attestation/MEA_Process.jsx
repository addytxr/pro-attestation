...
const MEA_Process = () => {
  ...
  const processSteps = [
    ...
    "Submission to MEA for Apostille Stamp",
    "Tracking & Delivery to Client"
  ]
    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center mb-8">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Our MEA Attestation Process</h2>
        </div>
