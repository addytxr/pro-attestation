...
import { FileText, FileChartPie, FileCheck,  } from 'lucide-react'
...
const Documents = () => {
  ...
  const requiredDocuments = [
    {
      title: "Original Company Agreement",
      description: "The primary document that needs to be apostilled/attested",
      icon: FileText,
    },
    {
      title: "Incorporation Certificate (if needed)",
      description: "Required for company-related documentation, if applicable",
      icon: FileChartPie,
    },
    {
      title: "Passport Copy (Authorized Signatory)",
      description: "Passport copy of the authorized signatory",
      icon: FileCheck,
    },
  ];
  return (
