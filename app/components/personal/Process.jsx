...
const Process = () => {
  ...
  const apostilleSteps = [
    "Notary Attestation (Local Notary verification of the original document)",
    "Home Department / SDM Attestation (Depending on the issuing state or urgency)",
    "MEA Apostille (Ministry of External Affairs affixes the Apostille Sticker)"
  ]

  const attestationSteps = [
    "Notary Attestation (Local Notary verification)",
    "Home Department Attestation (State-level authentication)",
    "MEA Attestation (Stamping by Ministry of External Affairs)",
    "Embassy Attestation (Legalization by the destination country's Embassy)"
  ]
